...
namespace OneJaxDashboard.Controllers
{
    ...
    public class BudgetTracking28DController : Controller
    {
        ...
        private List<SelectListItem> GetQuarters()
        {
            ...
            {
                new SelectListItem { Value = "Q1", Text = "Q1 (July - September)" },
                new SelectListItem { Value = "Q2", Text = "Q2 (October - December)" },
                new SelectListItem { Value = "Q3", Text = "Q3 (January - March)" },
                new SelectListItem { Value = "Q4", Text = "Q4 (April - June)" }
            };
        }
    }
}
